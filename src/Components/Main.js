...
const Main = () => {
  ...
  // Handle nav toggle button click event
  useEffect(() => {
              ...
              <ul className="nav__links" id="nav-links">
                ...
                <li className="link">
                  ...
                  <ul className="dropdown">
                    <li>
                      <a href="./Frontend/Games/games.html">Games</a>
                    </li>
                    <li>
                      <a href="/">Songs</a>
                    </li>
                    ...
                    <li>
                      <a href="/">Doctor Advice</a>
                    </li>
                  </ul>
                </li>
                <li className="link">
                  <a href="#all-services">Pages</a>
                </li>
                <li className="link">
                  <a href="/">Blog</a>
                </li>
                <li className="link">
                  <a href="./Frontend/Contact-Us/Contact-Us.html">Contact Us</a>
                </li>
                <li className="link">
                  <a href="./Frontend/Login/Login.html">Login</a>
                </li>
                <li className="link">
                  <a href="./Frontend/Account/profile.html">Account</a>
                </li>
              </ul>
            </nav>
          </div>
          <div className="forms">
            <div className="section__container header__container">
              <div className="header__content">
                ...
                <p className="text1">
                  "Every Step You Take Brings You Closer to Healing" "You’re Not
                  Alone—We’re Here to Help" "Your Mental Health Matters—Take the
                  First Step Today" "Find Strength and Resilience in Every
                  Moment" "Healing is a Journey—Let Us Walk It with You"
                </p>
                <a href="#all-services">
          ...
          <div className="container3">
            <div className="service__grid">
              <div className="service__card left">
                ...
                <a href="./Frontend/Services/Psychological.html">Learn More</a>
              </div>
              <div className="service__card center">
                ...
                <a href="./Frontend/Services/Physical.html">Learn More</a>
              </div>
              <div className="service__card right">
                ...
                <p>
                  Persistent sadness or depressive symptoms Extreme mood swings
                  and manic episodes Loss of interest in activities and social
                  withdrawal Difficulty managing emotions and mood stability
                </p>
                <a href="./Frontend/Services/mood.html">Learn More</a>
              </div>
              <div className="service__card left">
                <span>
                ...
                <p>
                  Difficulty forming or maintaining relationships Social anxiety
                  or avoidance Conflict with family or friends
                </p>
                <a href="./Frontend/Services/socialproblems.html">Learn More</a>
              </div>
              <div className="service__card center">
                <span>
                ...
                <p>
                  ...
                  hopelessness or helplessness Emotional numbness or detachment
                </p>
                <a href="./Frontend/Services/emotional.html">Learn More</a>
              </div>
              <div className="service__card right">
                <span>
                ...
                <p>
                  Difficulty concentrating or studying Poor academic performance
                  or grades Absenteeism or school avoidance
                </p>
                <a href="./Frontend/Services/academic.html">Learn More</a>
              </div>
            </div>
          </div>
        </section>
        <section className="section__container about__container" id="about">
          <div className="about__content left" id="about-section">
            ...
            <p className="container1">
              ...
              collection of expertly written articles and guides covering a wide
              range of health topics. From understanding common medical
              ...
              informed choices for your health. Discover practical health tips
              and lifestyle advice to optimize your physical and mental
              well-being. We believe that small changes can lead to significant
              improvements in your quality of life, and we're here to guide you
              on your path to a healthier and happier you.
            </p>
          </div>
